...
export function ArchivedProjects() {
  ...
  const getProjectDetails = async () => {
    const res = await fetch("/analysis/archivedProjects", {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      ...
      <div className="dashboard-menu d-flex flex-column px-4 py-3">
        <div>
          ...
          <div className="d-flex flex-column align-items-start my-5">
            ...
            <Link to="/archivedProjects" style={{ color: "#15589c" }}>
              <svg
                className="mx-2"
                width="26"
                height="22"
      ...
      <div className="dashboard-right-section d-flex flex-column w-100 px-4">
        ...
        <div className="d-flex flex-column dashboard-right-section-bottom mt-3">
          <div className="d-flex flex-row w-100 justify-content-between align-items-center">
            <h4 className="my-3">Archived Projects</h4>
          ...
          <table className="dashboard-table px-2 my-3">
            ...
            <tbody>
              {projectDetails.length === 0 ? (
                <tr>
                  <td colSpan="4">No archived projects</td>
                </tr>
              ) : (
                projectDetails.map((project) => (
                  <tr key={project.project__id}>
                    ...
                    <td>
                      ...
                      <Link
                        onClick={() => unArchiveProject(project.project__id)}
                      >
                        <svg
                          className="mx-2"
                          width="22"

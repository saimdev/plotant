...
export function TrashProjects() {
  ...
  const getProjectDetails = async () => {
    const res = await fetch("/analysis/trashedProjectsList", {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    const data = await res.json();
    console.log(data);
    setProjectDetails(data.trash);
  };

  const restoreProject = async (projectId) => {
    const res = await fetch("/analysis/projectRestore", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      ...
      <div className="dashboard-menu d-flex flex-column px-4 py-3">
        <div>
          ...
          <div className="d-flex flex-column align-items-start my-5">
            ...
            <Link to="/trashedProjects" style={{ color: "#15589c" }}>
              <svg
                className="mx-2"
                width="23"
                height="32"
      ...
      <div className="dashboard-right-section d-flex flex-column w-100 px-4">
        ...
        <div className="d-flex flex-column dashboard-right-section-bottom mt-3">
          <div className="d-flex flex-row w-100 justify-content-between align-items-center">
            <h4 className="my-3">Trashed Projects</h4>
          ...
          <input
            ...
            placeholder="Search trashed projects here...."
          />
          <table className="dashboard-table px-2 my-3">
            ...
            <tbody>
              {projectDetails.length === 0 ? (
                <tr>
                  <td colSpan="4">No projects deleted</td>
                </tr>
              ) : (

...
export function AllProjects() {
  ...
  const deleteProject = async (projectId) => {
    const res = await fetch("/analysis/projectDelete", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const archiveProject = async (projectId) => {
    const res = await fetch("/analysis/archiveProject", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      ...
      <div className="dashboard-menu d-flex flex-column px-4 py-3">
        <div>
          ...
          <div className="d-flex flex-column align-items-start my-5">
            ...
            <Link to="/allProjects" style={{ color: "#15589c" }}>
              <svg
                className="mx-2"
                width="25"
                height="25"
      ...
      <div className="dashboard-right-section d-flex flex-column w-100 px-4">
        ...
        <div className="d-flex flex-column dashboard-right-section-bottom mt-3">
          <div className="d-flex flex-row w-100 justify-content-between align-items-center">
            <h4 className="my-3">All Projects</h4>
          ...
          <input
            ...
            name=""
            id=""
            className="w-50 all-projects-search px-3 py-1"
            placeholder="Search your projects here...."
          />
          <table className="dashboard-table px-2 my-3">
                    ...
                    <td>
                      ...
                      <Link className="mx-2">
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clip-path="url(#clip0_516_5539)">
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M37.0459 0V17.6471H54.693V60H5.28125V0H37.0459ZM28.1412 21.1764C27.6153 21.1764 27.1423 21.4129 26.8 21.8329C25.2435 23.707 25.8188 27.8647 26.2141 30.3353C26.3023 30.8964 26.2283 31.4647 25.9883 31.9764L22.6176 39.2647C22.3706 39.7941 21.9753 40.2212 21.4741 40.5C19.3459 41.6823 15.7777 43.3023 15.3471 46.207C15.1918 47.1529 15.5059 47.9682 16.24 48.7023C16.7377 49.1752 17.3412 49.4117 17.9977 49.4117C20.5423 49.4117 22.1482 47.1706 23.8812 44.7706C24.6506 43.7012 25.8083 43.0447 27.0823 42.8682C29.4683 42.54 32.327 41.8517 34.0565 41.4C34.9283 41.1706 35.8177 41.227 36.6753 41.4988C38.1929 41.9858 38.7682 42.2823 40.5118 42.2823C42.0859 42.2823 43.1623 41.9152 43.6847 41.2058C44.1047 40.68 44.2071 39.9705 44.0023 39.1552C43.6318 37.8176 43.9388 36.3529 39.8447 36.3529C38.9271 36.3529 38.0341 36.4412 37.2894 36.5435C36.1388 36.6988 34.9988 36.2012 34.2577 35.2658C33.2482 33.9988 32.2212 32.5023 31.5083 31.4153C31.0035 30.6494 30.8341 29.7282 31 28.8176C31.4835 26.1706 31.5753 24.2047 30.2659 22.3588C29.7153 21.5717 28.9777 21.1764 28.1412 21.1764ZM40.5757 0.526187L54.1674 14.118H40.5757V0.526187Z"
                              fill="#15589c"
                            />
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M24.7207 40.5608C27.6042 39.2055 33.3431 38.5208 33.3431 38.5208C30.456 35.7396 28.7831 31.8008 28.7831 31.8008C27.4313 35.7573 25.0419 40.0596 24.7207 40.5608Z"
                              fill="#15589c"
                            />
                          </g>
                          <defs>
                            <clipPath id="clip0_516_5539">
                              <rect width="60" height="60" fill="white" />
                            </clipPath>
                          </defs>
                        </svg>
                      ...
                      <Link
                        className="mx-2"
                        onClick={() => {
                          archiveProject(project.project__id);
                        }}
                      >
                        <svg
                          width="22"
                        ...
                        >
                          ...
                          />
                          <path
                            d="M45.1722 13.7508C45.5252 13.7509 45.8878 13.7511 46.25 13.7461V25.0007C46.25 34.4287 46.25 39.143 43.321 42.0717C40.3922 45.0007 35.678 45.0007 26.25 45.0007H23.75C14.3219 45.0007 9.60787 45.0007 6.67892 42.0717C3.75 39.143 3.75 34.4287 3.75 25.0007V13.7461C4.1122 13.7511 4.47497 13.7509 4.82785 13.7508L23.125 13.7508V30.1145L18.8937 25.413C18.2009 24.6432 17.0154 24.581 16.2457 25.2737C15.476 25.9665 15.4136 27.152 16.1064 27.9217L23.6063 36.255C23.962 36.65 24.4685 36.8757 25 36.8757C25.5315 36.8757 26.038 36.65 26.3937 36.255L33.8937 27.9217C34.5865 27.152 34.524 25.9665 33.7543 25.2737C32.9845 24.581 31.799 24.6432 31.1063 25.413L26.875 30.1145V13.7508L45.1722 13.7508Z"
                            fill="#15589c"
                          />
                        </svg>
                      </Link>
                      <Link
                        className="mx-2"
                        onClick={() => {
                          deleteProject(project.project__id);
                        }}
                      >
                        <svg
                          width="24"
                        ...
                        >
                          <path
                            d="M14.3875 50.7075L10 20H50L45.6125 50.7075C45.4422 51.899 44.8478 52.989 43.9386 53.7775C43.0293 54.566 41.8661 55.0001 40.6625 55H19.3375C18.1339 55.0001 16.9707 54.566 16.0614 53.7775C15.1522 52.989 14.5578 51.899 14.3875 50.7075ZM52.5 10H40V7.5C40 6.83696 39.7366 6.20107 39.2678 5.73223C38.7989 5.26339 38.163 5 37.5 5H22.5C21.837 5 21.2011 5.26339 20.7322 5.73223C20.2634 6.20107 20 6.83696 20 7.5V10H7.5C6.83696 10 6.20107 10.2634 5.73223 10.7322C5.26339 11.2011 5 11.837 5 12.5C5 13.163 5.26339 13.7989 5.73223 14.2678C6.20107 14.7366 6.83696 15 7.5 15H52.5C53.163 15 53.7989 14.7366 54.2678 14.2678C54.7366 13.7989 55 13.163 55 12.5C55 11.837 54.7366 11.2011 54.2678 10.7322C53.7989 10.2634 53.163 10 52.5 10Z"
                            fill="#15589c"
                          />
                        </svg>
                      </Link>
